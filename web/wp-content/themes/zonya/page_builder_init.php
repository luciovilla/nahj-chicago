...
if(class_exists('AQ_Page_Builder')) {
	...
	if(class_exists('Woocommerce')){
		if(!( class_exists('AQ_Shop_Carousel_Block') )){
			require_once ( "page_builder_blocks/shop_carousel_block.php" );
			aq_register_block('AQ_Shop_Carousel_Block');
		}
	}
	...
	if(!( class_exists('AQ_Fact_Block') )){
		require_once ( "page_builder_blocks/fact_block.php" );
		aq_register_block('AQ_Fact_Block');
	}
	...
	if(!( class_exists('AQ_Parallax_Title_Block') )){
		require_once ( "page_builder_blocks/parallax_page_title_block.php" );
		aq_register_block('AQ_Parallax_Title_Block');
	}
