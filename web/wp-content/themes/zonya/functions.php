 ...
 * If the theme does not declare tommusrhodus-theme, then all items are loaded to avoid data loss when switching themes. Boo!
 * @since version 1.0.0
 * @author TommusRhodus
 */
if(!( function_exists('ebor_declare_theme_support') )){
	function ebor_declare_theme_support() {
		...
		add_theme_support('tommusrhodus-popular-widget');
		add_theme_support('tommusrhodus-contact-widget');
		add_theme_support('tommusrhodus-elemis-shortcodes');
	}
