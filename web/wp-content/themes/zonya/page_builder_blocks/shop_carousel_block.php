...
class AQ_Shop_Carousel_Block extends AQ_Block {
	...
	function __construct() {
		$block_options = array(
			...
			'size' => 'span12',
			'resizable' => 0,
			'block_description' => 'Add a carousel of<br />product posts to the page.'
		);
		parent::__construct('aq_shop_carousel_block', $block_options);
	}//end construct
