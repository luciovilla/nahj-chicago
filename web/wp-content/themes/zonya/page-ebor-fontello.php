<?php 
	/**
	 * This template exists purely for demo purposes
	 * It is shown on the /ebor-fontello/ url of the site.
	 * Simple delete this template if you need this URL for anything else.
	 */
	get_header(); 
?>
  ...
  <div class="light-wrapper">
    <div class="container inner">
     ...
     <h3 class="section-title text-center">500+ Font Icons</h3>
    <div class="lead text-center">any style can be applied to these retina-ready icons</div>
      ...
      <div class="row-fluid retina-icons-code">
        <div class="col-sm-6">
