Vagrant.configure("2") do |config|
  ...
  config.vm.define :local do |box|
    box.vm.hostname = "local.nahj-chi.com"

    # Static IP for testing.
    box.vm.network :private_network, ip: "192.168.240.108"
    box.vm.network :forwarded_port, guest: 22, host: 2418, auto_correct: true
